...
const Cards = () => {
  return (
    <div className='grid lg:grid-cols-5 gap-4 p-4'>
        ...
        <div className='lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg'>
           <div className='flex flex-col w-full pb-4'>
             <p className='text-2xl font-bold'>$5871</p>
             <p className='text-gray-600 '>All Revenue</p>
              </div>  
              <p className='bg-green-200 flex justify-center items-center p-2 rounded-lg'>
        ...
        <div className=' bg-white flex justify-between w-full border p-4 rounded-lg'>
           <div className='flex flex-col w-full pb-4'>
             <p className='text-2xl font-bold'>2921</p>
             <p className='text-gray-600 '>Customers</p>
              </div> 
              <p className='bg-red-200 flex justify-center items-center p-2 rounded-lg'>
              <span className='text-red-700 text-lg'>8%</span>
              </p>
        </div>
